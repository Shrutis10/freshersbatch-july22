...
namespace Assignment_2.Models
{
    public class BusInfoDB
    {
        ...
        {
            using(SqlConnection con = new SqlConnection("data source=.;database=ASP.Net;integrated security=SSPI"))
            {
        ...
        public List<BusInfo> busInfoByAmount()
        {
            List<BusInfo> buslist = new List<BusInfo>();
            using (SqlConnection con = new SqlConnection("data source=.;database=ASP.Net;integrated security=SSPI"))
            {
        ...
        public List<BusInfo> busInfoByRating()
        {
            List<BusInfo> buslist = new List<BusInfo>();
            using (SqlConnection con = new SqlConnection("data source=.;database=ASP.Net;integrated security=SSPI"))
            {
        ...
        public List<BusInfo> busInfoByDate()
        {
            List<BusInfo> buslist = new List<BusInfo>();
            using (SqlConnection con = new SqlConnection("data source=.;database=ASP.Net;integrated security=SSPI"))
            {
        ...
        public List<BusInfo> busInfoByBoardingPoint()
        {
            List<BusInfo> buslist = new List<BusInfo>();
            using (SqlConnection con = new SqlConnection("data source=.;database=ASP.Net;integrated security=SSPI"))
            {
