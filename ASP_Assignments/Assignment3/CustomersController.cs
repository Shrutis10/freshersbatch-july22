...
namespace Assignment_3.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerId,CustomerName,City,Age,PhoneNumber,Pincode")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerId,CustomerName,City,Age,PhoneNumber,Pincode")] Customer customer)
        {
            if (ModelState.IsValid)
            {
